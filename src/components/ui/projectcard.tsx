      ...
      <div className="p-0 mx-6 flex justify-between items-center">
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent className="w-56">
            ...
            <DropdownMenuItem className="hover:bg-destructive active:bg-destructive focus:bg-destructive hover:text-white active:text-white focus:text-white" onSelect={handleDeleteClick}>
               ...
               <AlertDialogContent>
                 <AlertDialogHeader>
                   ...
                   <AlertDialogDescription>
                     ...
                     innovation and remove your data from our servers.
                   </AlertDialogDescription>
                 </AlertDialogHeader>
                 <AlertDialogFooter>
      ...
      <CardContent className="pb-0">
        <div className="flex  justify-between gap-5">
          <div className="flex-1">
            <Image src="/Image Icon.png" width={300} height={150} alt="Dashboard image" className="" />
          </div>
          <div className="flex flex-col gap-3 flex-1">
            ...
            <CardDescription className="max-w-[400px]">
              ...
              exercitationem maiores distinctio recusandae similique esse molestiae dicta optio id laborum libero unde. ...
            </CardDescription>
