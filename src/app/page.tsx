...
const NEXT_PUBLIC_EMAIL_TEMPLATE_ID = process.env.NEXT_PUBLIC_EMAIL_TEMPLATE_ID
const NEXT_PUBLIC_EMAIL_SERVICE_ID = process.env.NEXT_PUBLIC_EMAIL_SERVICE_ID
...
export default function LandingPage() {
	...
	const onSubmit = async (data: FormValues) => {
		...
		if (!NEXT_PUBLIC_EMAIL_TEMPLATE_ID || !NEXT_PUBLIC_EMAIL_SERVICE_ID) {
			console.error("Email was not sent!!");
			return;
		}			

		emailjs.send(NEXT_PUBLIC_EMAIL_SERVICE_ID, NEXT_PUBLIC_EMAIL_TEMPLATE_ID, {...data})

		emailjs
			.send(NEXT_PUBLIC_EMAIL_SERVICE_ID, NEXT_PUBLIC_EMAIL_TEMPLATE_ID, {...data})
			.then(
				() => {
					toast({
